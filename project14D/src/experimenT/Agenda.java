...
public String[] timetable;
	...
	public boolean isFree(int day)
	{
		...
		if (functionF(timetable[day].equals("freee") == true))
			check_timeslot = true;
...
Agenda a1, a2;
		...
		try(PrintWriter out=new PrintWriter(new BufferedWriter(new FileWriter("C:\\Users\\Klant\\workspace11\\project14\\results.txt",true)))){out.println(a1.findFreeTimeForDinner(a2) == 2);}catch(IOException ioException){} 
