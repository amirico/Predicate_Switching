...
class minesweeper 
{
  ...
  */
  ...
  {
    if (trace((validIndex(r, c)),109,8,109,24,"/C:/Users/Klant/workspace2/project28/src/TestMineSweeper.java")) 
    {
      return mines[r][c];
    } 
    else 
  ...
  */
  ...
  {
    if (trace((validIndex(r, c)),127,8,127,24,"/C:/Users/Klant/workspace2/project28/src/TestMineSweeper.java")) 
    {
      return tiles[r][c];
    } 
    else 
  ...
  */
  ...
  {
    if (trace((status == "play" && validIndex(r,c)),155,8,155,43,"/C:/Users/Klant/workspace2/project28/src/TestMineSweeper.java")) 
    {
        //IF tile is clear set to clear
        if (getTiles(r,c) == 0)
            tiles[r][c] = 0;
        if (trace((tiles[r][c] == 1 || tiles[r][c] == 2),160,12,160,48,"/C:/Users/Klant/workspace2/project28/src/TestMineSweeper.java")) 
        {
            tiles[r][c] = t;
            ...
            //CHECK FOR GAME WIN
            if (trace((tiles[r][c] == 3 && mines[r][c] == 9),168,16,168,52,"/C:/Users/Klant/workspace2/project28/src/TestMineSweeper.java")) 
            {
                cFlags++;
                gameWon();
            }
            
            if (trace((mines[r][c] == 0 && t == 0),174,16,174,42,"/C:/Users/Klant/workspace2/project28/src/TestMineSweeper.java")) 
            {
        ...
        if (trace((tiles[r][c] == 3),189,12,189,28,"/C:/Users/Klant/workspace2/project28/src/TestMineSweeper.java"))//DONT UNCOVER FLAGGED TILES
        {
            if (t != 0)
                if (trace((mines[r][c] == 9 && tiles[r][c] == 3 && t == 2),192,20,192,66,"/C:/Users/Klant/workspace2/project28/src/TestMineSweeper.java")) //DECREMENT NUM FLAGS IF SWITCHING TO QUESTIONMARK
                {
		  cFlags--;
		 }
                tiles[r][c] = t;
  ...
  */
  public char getBoard (int r, int c) 
  {
    ...
    if (trace((status == "lose"),279,8,279,24,"/C:/Users/Klant/workspace2/project28/src/TestMineSweeper.java")) { //HANDLE LOSE STATUS DRAWING
        if (trace((tiles[r][c] == 0),280,12,280,28,"/C:/Users/Klant/workspace2/project28/src/TestMineSweeper.java"))
        {
    ...
    if (trace((status == "play"),291,8,291,24,"/C:/Users/Klant/workspace2/project28/src/TestMineSweeper.java")) //HANDLE PLAY DRAWING
    {
        ...
        if (trace((tiles[r][c] == 0),300,12,300,28,"/C:/Users/Klant/workspace2/project28/src/TestMineSweeper.java")) //IF OPEN TILE
        {
    ...
    if (trace((status == "win"),309,8,309,23,"/C:/Users/Klant/workspace2/project28/src/TestMineSweeper.java"))//HANDLE DRAWING BOARD POST-WIN
    {
  ...
  */
  private void initGame (int newRows, int newCols) 
  {
    ...
    if (trace(((newRows >= 1) && (newCols >= 1)),326,8,326,40,"/C:/Users/Klant/workspace2/project28/src/TestMineSweeper.java")) 
    {
  ...
  */
  ...
  {
    if (r == tiles.length || c == tiles[r].length) //END FUNCTION WHEN OUT OF ROWS
        return;
  ...
  */
  private void placeMines () 
  {
    ...
    for (int i = 0; i < cMines; i++)
    {
        ...
        if (trace((mines[r][c] == 9),373,12,373,28,"/C:/Users/Klant/workspace2/project28/src/TestMineSweeper.java")) //IF RANDOM PLACE IS ALREADY MINE DEC I AND DO IT AGAIN
        {
            i--;
            continue;
        }
  ...
  */
  private void calculateClues () 
  {
    for (int r = 0; r < mines.length; r++) 
    {
        for (int c = 0; c < mines[r].length; c++) 
        {
            if (trace((mines[r][c] == 9),394,16,394,32,"/C:/Users/Klant/workspace2/project28/src/TestMineSweeper.java")) 
            {
                if (r-1 >= 0 && c-1 >= 0 && mines[r-1][c-1] != 9) // r-1, c-1
                    mines[r-1][c-1]++;
                if (r-1 >= 0 && c >= 0 && mines[r-1][c] != 9) //r-1, c
                    mines[r-1][c]++;
                if (r-1 >= 0 && c+1 < mines[r].length && mines[r-1][c+1] != 9)//r-1,c+1
                    mines[r-1][c+1]++;
                if (c-1 >= 0 && mines[r][c-1] != 9) //r, c-1
                    mines[r][c-1]++;
                if (c+1 < mines[r].length && mines[r][c+1] != 9)//r,c+1
                    mines[r][c+1]++;
                if (r+1 < mines.length && c-1 >= 0 && mines[r+1][c-1] != 9) // r+1, c-1
                    mines[r+1][c-1]++;
                if (r+1 < mines.length && mines[r+1][c] != 9) //r+1, c
                    mines[r+1][c]++;
                if (r+1 < mines.length && c+1 < mines[r].length && mines[r+1][c+1] != 9) //r+1, c+1
                    mines[r+1][c+1]++;
            }//END MINE IF CHECK
        }//END INNER FOR
    }//END OUTER FOR
  ...
  */
  ...
  {
    if (r >= mines.length || r < 0 || c < 0 || c >= mines[r].length) // fault 
        return false;
    return true;
  }
  ...
  */
  ...
  {
    if (trace((cMines == cFlags),437,8,437,24,"/C:/Users/Klant/workspace2/project28/src/TestMineSweeper.java"))
    {
        status = "win";
        return true;
    }
