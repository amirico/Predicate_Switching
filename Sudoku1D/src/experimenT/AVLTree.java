...
//							.doubleValue();
					boolean bb = tree.find(value);
					System.out.println(bb);
					if (functionF(bb)) {
						System.out.println("test");
						System.out.println("Value " + value
								+ " found in the tree");
					try(PrintWriter out=new PrintWriter(new BufferedWriter(new FileWriter("C:\\Users\\Klant\\workspace2\\project12"+"\\results.txt",true)))){out.println(bb);}catch(IOException ioException){} 
} else {
						System.out.println("Value " + value
