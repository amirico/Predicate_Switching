...
public class TicSolver {
	...
	private int recurse(boolean omove) {
		...
		for(int r=0; r<3; r++)
			for(int c=0; c<3; c++)
				if (trace((b[r][c]=='.'),46,8,46,20,"/C:/Users/Klant/workspace2/project7/src/TicSolver.java")) {
					hasplayed = true;
					b[r][c] = omove?'O':'X';
					int ret = recurse(!omove);
					if (ret==2) iwin = true;
	...
	public static void main(String[] args) {
		...
		int mode = 1;
		if (trace((mode == 1),99,6,99,15,"/C:/Users/Klant/workspace2/project7/src/TicSolver.java")) {
