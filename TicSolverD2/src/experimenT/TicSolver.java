...
TicSolver test = new TicSolver();
		...
		if (functionF(mode == 1)) {
			...
			try(PrintWriter out=new PrintWriter(new BufferedWriter(new FileWriter("C:\\Users\\Klant\\workspace2\\project7\\results.txt",true)))){out.println((test.whoWins(board) == "FIRST"));}catch(IOException ioException){} 
