...
private long duration;
	...
	protected TheoryTimer2 (long duration) {
...
TheoryTimer2 t = new TheoryTimer2(500);
		...
		try(PrintWriter out=new PrintWriter(new BufferedWriter(new FileWriter("C:\\Users\\Klant\\workspace2\\project16\\results.txt",true)))){out.println((t.timeRemaining() <= 400));}catch(IOException ioException){} 
