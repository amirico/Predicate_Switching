...
experimentalY++;
 	if (trace((experimentalI == experimentalY),19,6,19,36,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) return !b; else  return b;}
protected TreeNode myRoot;
	...
	private static TreeNode copy(TreeNode t) {
		if (trace((t == null),37,6,37,15,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
			return null;
		} else {
	...
	public BinaryTree(ArrayList preorder, ArrayList inorder) {
		if (trace((preorder != null),45,6,45,22,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
	...
	private static TreeNode add(TreeNode t, int pos, ArrayList preorder,
			ArrayList inorder) {
		if (trace((t == null),54,6,54,15,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
			return new TreeNode(preorder.get(pos));
		}
		if (trace((inorder.indexOf(preorder.get(pos)) < inorder.indexOf(t.myItem)),57,6,57,68,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
	...
	private static void printPreorder(TreeNode t) {
		if (trace((functionF(t != null)),74,6,74,26,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
	...
	private static void printInorder(TreeNode t) {
		if (trace((functionF(t != null)),90,6,90,26,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
	...
	private static int height(TreeNode x) {
		if (trace((x == null),148,6,148,15,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
			return 0;
		} else if (trace((x.myLeft == null && x.myRight == null),150,13,150,50,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
			return 1;
		} else {
			TreeNode tallestChild = x.myLeft;
			if (trace((height(x.myRight) > height(x.myLeft)),154,7,154,43,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
	...
	private static boolean isCompletelyBalanced(TreeNode t) {
		if (trace((height(t) == 0 || height(t) == 1),166,6,166,38,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
			return true;
		}
	...
	private void check(TreeNode t) throws IllegalStateException {
		if (trace((t == null),188,6,188,15,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
			return;
		}
		if (trace((alreadySeen.contains(t)),191,6,191,29,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
			throw new IllegalStateException();
		}
		alreadySeen.add(t);
		if (trace((t.myLeft != null),195,6,195,22,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
			check(t.myLeft);
		}
		if (trace((t.myRight != null),198,6,198,23,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
			check(t.myRight);
		}
	}
	...
	private TreeNode fibTreeHelper(int n) {
		if (trace((n == 0),210,6,210,12,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
			return new TreeNode(new Integer(0));
		}
		if (trace((n == 1),213,6,213,12,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
	...
	private TreeNode exprTreeHelper(String expr) {
		if (trace((expr.charAt(0) != '('),233,6,233,27,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
			...
			for (int k = 1; k < expr.length() - 1; k++) {
				if (trace((expr.charAt(k) == '('),243,8,243,29,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
					nesting++;
				}
				if (trace((expr.charAt(k) == ')'),246,8,246,29,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
					nesting--;
				}
				if (trace((nesting == 0,249,8,250,57,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java"))
	...
	private static void optimizeHelper(TreeNode cur) {
		int left, right;
		if (trace((cur.myLeft == null),277,6,277,24,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) { // nodes in expression tree must either have 0
		...
		try {
			...
			if (trace((cur.myItem.equals("*")),287,7,287,29,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
	...
	private class InorderIterator implements Iterator {
		...
		public Object next() {
			...
			if (trace((!nodeStack.isEmpty()),332,7,332,27,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
				nextNode = nodeStack.pop();
				assert nextNode != null; // since nodeStack was not empty
											// before the pop
				if (trace((nextNode.myRight != null),336,8,336,32,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
...
System.out.println(t.isCompletelyBalance());
	...
	public void print() {
		if (trace((functionF(myRoot != null)),379,6,379,31,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
	...
	private static void printHelper(TreeNode root, int indent) {
		if (trace((functionF(root.myRight != null)),387,6,387,37,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
			printHelper(root.myRight, indent + 1);
		}
		println(root.myItem, indent);
		if (trace((functionF(root.myLeft != null)),391,6,391,36,"/C:/Users/Klant/workspace11/project20/src/experimenT/BinaryTree.java")) {
