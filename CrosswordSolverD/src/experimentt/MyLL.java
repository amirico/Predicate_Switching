...
public class MyLL {// implements List<Integer> {
	...
	public boolean add(Integer arg0) {
		if (trace((head == null),30,6,30,18,"/C:/Users/Klant/workspace2/project9/src/MyLL.java")) {
	...
	public Integer get(MyNode it, int arg) {
		...
		if ((trace( it==null ,58,7,58,15,"/C:/Users/Klant/workspace2/project9/src/MyLL.java")))
			return null;
		else if ((trace( arg <= 0 ,60,12,60,20,"/C:/Users/Klant/workspace2/project9/src/MyLL.java")))
			return it.value;
		else // arg > 0 && it != null
	...
	public Integer get(int idx) {
		...
		if((trace( it == null ,72,6,72,16,"/C:/Users/Klant/workspace2/project9/src/MyLL.java"))) {
			return null;
		} else if ((trace( idx<=0 ,74,14,74,20,"/C:/Users/Klant/workspace2/project9/src/MyLL.java"))) {
			return it.value;
		} // should be no else
		return null;
	}
	...
	public boolean remove(Integer arg0) {
		if ((trace( head!=null && head.value==arg0 ,127,7,127,37,"/C:/Users/Klant/workspace2/project9/src/MyLL.java"))) {
			head = head.next;
			return true;
		} else if (trace((head==null),130,13,130,23,"/C:/Users/Klant/workspace2/project9/src/MyLL.java")) {
			return false;
		} else {
			MyNode it = head.next;
			MyNode prev = head;
			while ( it!=null ) {
				if((trace( it.value==arg0 ,136,8,136,22,"/C:/Users/Klant/workspace2/project9/src/MyLL.java"))) {
					prev.next = it.next;
					return true;
				}
				prev = it;
