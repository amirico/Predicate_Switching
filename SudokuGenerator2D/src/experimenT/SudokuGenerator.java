...
experimentalY++;
//	System.out.println(experimentalY);
...
public static final int BOARD_WIDTH = 9;
   ...
   public SudokuGenerator() {
	...
	public int[][] nextBoard(int difficulty)
	{
		...
		try(PrintWriter out=new PrintWriter(new BufferedWriter(new FileWriter("C:\\Users\\Klant\\workspace2\\project1\\results.txt",true)))){out.println(zeros != 9);}catch(IOException ioException){}
return board;
...
SudokuGenerator sg = new SudokuGenerator();
		sg.nextBoard(35);
//		try(PrintWriter out=new PrintWriter(new BufferedWriter(new FileWriter("C:\\Users\\Klant\\workspace2\\project1\\results.txt",true)))){out.println((2200));}catch(IOException ioException){}
