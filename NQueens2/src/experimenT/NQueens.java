...
NQueens q = new NQueens();
  ...
  try(PrintWriter out=new PrintWriter(new BufferedWriter(new FileWriter("C:\\Users\\Klant\\workspace11\\NQueens2\\results.txt",true)))){out.println(numSolns==2);}catch(IOException ioException){} 
