...
// we need to get input ... for now we'll use the Scanner class
		...
		try(PrintWriter out=new PrintWriter(new BufferedWriter(new FileWriter("C:\\Users\\Klant\\workspace11\\BMICalculator2\\results.txt",true)))){out.println((bmi != 0));}catch(IOException ioException){} 
