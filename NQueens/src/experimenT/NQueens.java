...
//      System.out.println(numSolns==2);
      try(PrintWriter out=new PrintWriter(new BufferedWriter(new FileWriter("C:\\Users\\Klant\\workspace11\\NQueens\\results.txt",true)))){out.println(numSolns==2);}catch(IOException ioException){} 
