...
public class NQueensTR
{
   ...
   */
   ...
   {  
//   System.out.println(row+","+numQueens);
...
//         print(board, numQueens);
      ...
      int numSolutions = 0;
      System.out.println(" ");
//      System.out.println("Start loop, row: "+row);
        for (int col = 0; col < numQueens; col++)
        {  
//        	System.out.println(!attacked(board,row,col));
        	if (! attacked(board, row, col))
        	{  
           board[row] = col;
//           System.out.println("at col: " + col + ": free");
//           Syste
//           System.out.println("true at " +(col+1) +"th collumn");
//           System.out.println("Call to generateSolns");   
           numSolutions += generateSolns(board, row+1, numQueens);
        	}
        	else {
//            	System.out.println("attacked at col: "+col);	
            	}
        }
//        print(board, row, numQueens);
//        System.out.println("_________________________");
