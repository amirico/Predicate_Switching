...
public class Sudoku {
    ...
    public static void main(String[] args) {
        ...
        writeMatrix(matrix);
        if (trace((solve(0,0,matrix)),113,12,113,29,"/C:/Users/Klant/workspace2/project2/src/Sudoku.java"))  {  // solves in place
            writeMatrix(matrix);
            int ones = 0; for(int el : matrix[0]) {if (el == 1) ones++;}System.out.println(ones == 1);
        }
        else{
    ...
    static boolean solve(int i, int j, int[][] cells) {
        if (trace((i == 9),122,12,122,18,"/C:/Users/Klant/workspace2/project2/src/Sudoku.java")) {
            i = 0;
            if (++j == 9)
                return true;
        }
        ...
        for (int val = 1; val <= 9; ++val) {
            if (trace((legal(i,j,val,cells)),131,16,131,36,"/C:/Users/Klant/workspace2/project2/src/Sudoku.java")) {
                cells[i][j] = val;
