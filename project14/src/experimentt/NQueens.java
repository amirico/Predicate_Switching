...
public class NQueens
{
   ...
   */
   ...
   {  print(board, row, numQueens);
      if (trace((row == numQueens) ,24,10,24,26,"/C:/Users/Klant/workspace2/project15/src/NQueens.java"))
      ...
      { int numSolutions = 0;
        ...
        {  if (trace((! attacked(board, row, col)),33,15,33,42,"/C:/Users/Klant/workspace2/project15/src/NQueens.java"))
           {  board[row] = col;
   ...
   */
   ...
   {  for (int i = 0; i < r; i++)
         if ((trace( conflict(r, c, i, board[i] ) ,52,14,52,42,"/C:/Users/Klant/workspace2/project15/src/NQueens.java")))
         {  return true;
         }
      return false;
   }
   ...
   {   System.out.println();
       ...
       for (int r = 0; r < numQueens; r++)
       {
          for (int c = 0; c < numQueens; c++)
             if (trace((c == board[r] && r < numPlaced),86,17,86,47,"/C:/Users/Klant/workspace2/project15/src/NQueens.java")) 
                System.out.print('Q');
             else
                System.out.print('.');
          System.out.println();
