...
public class Agenda 
{
	...
	public boolean isFree(int day)
	{
		...
		if (trace((timetable[day].equals("freee") == true),49,6,49,44,"/C:/Users/Klant/workspace11/project14/src/Agenda.java"))
			check_timeslot = true;
	...
	public int getFirstFreeTimeSlot()
	{
		...
		{
			if (trace((isFree(x)),65,7,65,16,"/C:/Users/Klant/workspace11/project14/src/Agenda.java"))
			{
				index_timeslot = x;
				x = timetable.length;
			}
	...
	public int findFreeTimeForDinner(Agenda a)
	{
		...
		while(x<timetable.length)
		{
			if (trace((isFree(x) && a.isFree(x)),86,7,86,31,"/C:/Users/Klant/workspace11/project14/src/Agenda.java"))
			{
