...
Agenda a1, a2;
		...
		try(PrintWriter out=new PrintWriter(new BufferedWriter(new FileWriter("results.txt",true)))){out.println(a1.findFreeTimeForDinner(a2) == 2);}catch(IOException ioException){} 
