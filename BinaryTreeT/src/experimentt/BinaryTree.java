...
public class BinaryTree {
	...
	private static TreeNode copy(TreeNode t) {
		if (trace((t == null),25,6,25,15,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
			return null;
		} else {
	...
	public BinaryTree(ArrayList preorder, ArrayList inorder) {
		if (trace((preorder != null),33,6,33,22,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
	...
	private static TreeNode add(TreeNode t, int pos, ArrayList preorder,
			ArrayList inorder) {
		if (trace((t == null),42,6,42,15,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
			return new TreeNode(preorder.get(pos));
		}
		if (trace((inorder.indexOf(preorder.get(pos)) < inorder.indexOf(t.myItem)),45,6,45,68,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
	...
	private static void printPreorder(TreeNode t) {
		if (trace((t != null),62,6,62,15,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
	...
	private static void printInorder(TreeNode t) {
		if (trace((t != null),78,6,78,15,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
	...
	private static int height(TreeNode x) {
		if (trace((x == null),136,6,136,15,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
			return 0;
		} else if (trace((x.myLeft == null && x.myRight == null),138,13,138,50,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
			return 1;
		} else {
			TreeNode tallestChild = x.myLeft;
			if (trace((height(x.myRight) > height(x.myLeft)),142,7,142,43,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
	...
	private static boolean isCompletelyBalanced(TreeNode t) {
		if (trace((height(t) == 0 || height(t) == 1),154,6,154,38,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
			return true;
		}
	...
	private void check(TreeNode t) throws IllegalStateException {
		if (trace((t == null),176,6,176,15,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
			return;
		}
		if (trace((alreadySeen.contains(t)),179,6,179,29,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
			throw new IllegalStateException();
		}
		alreadySeen.add(t);
		if (trace((t.myLeft != null),183,6,183,22,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
			check(t.myLeft);
		}
		if (trace((t.myRight != null),186,6,186,23,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
			check(t.myRight);
		}
	}
	...
	private TreeNode fibTreeHelper(int n) {
		if (trace((n == 0),198,6,198,12,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
			return new TreeNode(new Integer(0));
		}
		if (trace((n == 1),201,6,201,12,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
	...
	private TreeNode exprTreeHelper(String expr) {
		if (trace((expr.charAt(0) != '('),221,6,221,27,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
			...
			for (int k = 1; k < expr.length() - 1; k++) {
				if (trace((expr.charAt(k) == '('),231,8,231,29,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
					nesting++;
				}
				if (trace((expr.charAt(k) == ')'),234,8,234,29,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
					nesting--;
				}
				if (trace((nesting == 0
						&& (expr.charAt(k) == '*' || expr.charAt(k) == '+')) ,237,8,238,57,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")){
					opPos = k;
					break;
				}
				// you fill this in
	...
	private static void optimizeHelper(TreeNode cur) {
		int left, right;
		if (trace((cur.myLeft == null),265,6,265,24,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) { // nodes in expression tree must either have 0
		...
		try {
			...
			if (trace((cur.myItem.equals("*")),275,7,275,29,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
	...
	private class InorderIterator implements Iterator {
		...
		public Object next() {
			...
			if (trace((!nodeStack.isEmpty()),320,7,320,27,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
				nextNode = nodeStack.pop();
				assert nextNode != null; // since nodeStack was not empty
											// before the pop
				if (trace((nextNode.myRight != null),324,8,324,32,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
	...
	public void print() {
		if (trace((myRoot != null),364,6,364,20,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
	...
	private static void printHelper(TreeNode root, int indent) {
		if (trace((root.myRight != null),372,6,372,26,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
			printHelper(root.myRight, indent + 1);
		}
		println(root.myItem, indent);
		if (trace((root.myLeft != null),376,6,376,25,"/C:/Users/Klant/workspace2/project11/src/BinaryTree.java")) {
