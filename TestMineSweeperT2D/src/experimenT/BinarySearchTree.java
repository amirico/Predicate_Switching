...
new BinarySearchTree().mainNonStatic();
    ...
    public void mainNonStatic() {
        ...
        try(PrintWriter out=new PrintWriter(new BufferedWriter(new FileWriter("C:\\Users\\Klant\\workspace11\\project93T\\results.txt",true)))){out.println(bst.subtree(bst1) == true);}catch(IOException ioException){} 
